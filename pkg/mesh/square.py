...
class Square:
    def __init__(self, ref, side, screen, ide):
        ...
        ##agente socorrista
        self.qualAgent = "V" ##V = vasculhador, S = socorrista
    ...
    def show(self):
        ...
        elif self.agent == True and self.qualAgent == 'V':
            pygame.draw.rect(self.screen,(0,255,0),(self.ref[0],self.ref[1],self.side,self.side))

        elif self.agent == True and self.qualAgent == 'S':
...
## muda agent
    def changeAgent(self, letraAgent):
        self.qualAgent = letraAgent